...
public class SimulatorFarms {
	...
	public static void main(String[] args) {
		...
		int totalTime = TotalFarms.TotalFarms.simulationTime;
		
		outputFileLog = TotalFarms.Writing.Log();
		outputFileData = TotalFarms.Writing.Data();
		outputFileMeta = TotalFarms.Writing.Meta();
