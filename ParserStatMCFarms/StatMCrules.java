...
void Input() throws ParseException, NumberFormatException, RuntimeException, ParseException {Token x=null, symbol=null, which=null ;
    ...
    AnalyserFarms.namesToCheckList.clear();
    AnalyserFarms.namesToCheckListArray.clear();
    jj_consume_token(SEMICOLON);
...
int value = Integer.parseInt(x.image);
    TraceAnalyser.AnalyserFarms.intProperty = value;
  }
...
TraceAnalyser.AnalyserFarms.whichProperty = whichOne.image;
        break;
        }
      case SYMBOL_PROP_COUNT:{
...
TraceAnalyser.AnalyserFarms.symbolProperty = symbol.image;
      } else if (jj_2_2(2)) {
...
{if ("" != null) return symbol;}
  ...
  final public void AgentName() throws ParseException, NumberFormatException, RuntimeException, ParseException {Token name, x=null, y=null, z=null;
    ...
    jj_consume_token(RR);
if (y == null && z == null){
    TraceAnalyser.AnalyserFarms.namesToCheckList.add(name.image + "(" + x.image + ")");}else{
    if (z == null) {
    TraceAnalyser.AnalyserFarms.namesToCheckList.add(name.image + "(" + x.image + "," + y.image + ")");}else{
    TraceAnalyser.AnalyserFarms.namesToCheckList.add(name.image + "(" + x.image + "," + y.image + "," + z.image + ")");}}
    ...
    TraceAnalyser.AnalyserFarms.namesToCheckListArray.add(xValueList);}else{
    if (z == null) {
    int xValue = Integer.parseInt(x.image);
    ...
    xyValues.add(xValue);
    xyValues.add(yValue);
    TraceAnalyser.AnalyserFarms.namesToCheckListArray.add(xyValues);}else{
    int xValue = Integer.parseInt(x.image);
    int yValue = Integer.parseInt(y.image);
    ...
    TraceAnalyser.AnalyserFarms.namesToCheckListArray.add(xyzValues);}}
  }
