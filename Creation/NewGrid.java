...
public class NewGrid {
	...
	public static ArrayList<ArrayList<Integer>> newGrid(ArrayList<ArrayList<Integer>> LocList, int newX, int newY){
		...
		for (int i=0; i < LocList.size(); i++){
			...
			newList.add(newLoc);
			int position = getPosition50(InitCond.ModelNumber);
			ModelFarms.LocationHistory.get(i).add(position, newLoc);
		}
...
//		System.out.println(" ");
		...
		for (ArrayList<Integer> key : Counting.keySet()){		
			System.out.print("S(" + key.get(0) + "," + key.get(1) + ")[" + Counting.get(key) + "]||");
		}
		System.out.print("I1(" + newFarmValueX + "," + newFarmValueY + ")[1]");
		System.out.println(" ");
		
	    System.out.println("To analyse with stat MC:");
	    System.out.print("{");
	    for (ArrayList<Integer> key : Counting.keySet()){		
			System.out.print("I1(" + key.get(0) + "," + key.get(1) + "), ");
		}
		System.out.print("I1(" + newFarmValueX + "," + newFarmValueY + ")}");
		System.out.println(" ");
...
//        }}}}}}}}
	...
	public static int getPosition50(int modelnumber){
		if (modelnumber == 50){
			int value = 0;
			return value;
		}else{if (modelnumber == 25){
